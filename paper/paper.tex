...
depending on the location of the true fixation point within the subject's field of view.
...
into both accuracy and precision. Wherein accuracy is the tendency for the measure
...
metrics of the precision in these models vary in the way they rank technologies\cite{Niehorster2020}. We can conclude from this that the patterns of systematic error in eye tracking
data are more complicated that can be quanitifed by a single metric.
...
and the error profile of the gaze fixation technology.
